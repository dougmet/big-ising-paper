...
\begin{figure}
<<density, echo=FALSE, message=FALSE, fig.width=3.5, fig.height=3.5>>=
library(ggplot2)
library(yaml)
library(readr)

em_raw <- read_csv("data/em.csv", col_names = c("M", "E"))
...
<<clusters, echo=FALSE, message=FALSE, fig.width=3.5, fig.height=3.5>>=library(readr)
library(readr)
library(ggplot2)
library(dplyr)
